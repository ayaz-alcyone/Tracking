            ...
            <div class="loginWrapper">
                <section class="d-inline-block">
                    <div class="loginHeader pt-1">
                        ...
                        <h5 class="text-center textDark pt-4 mt-3 pb-3">Welcome back! Admin Login.</h5>
                    </div>
                    ...
                    <div class="loginBody">
                        ...
                        @endif
                        <form class="pl-3 pr-3" method='POST' action="{{ route('post_admin_login') }}">
                            <div class="inputWithIcon mt-3">
                                <label for="email" class="mb-0">Sign in with your username</label>
                                <input type="email" value="{{ old('email') }}" class="mt-1 email" name="email">
                            ...
                            <div class="inputWithIcon">
                                ...
                                <input type="password" value="{{ old('password') }}" class="mt-1 password" name="password">
                    ...
                    <div class="loginFooter">
                        <span><a href="{{ route('forgotpassword') }}" class="textDark">Forgot Password?</a></span>
